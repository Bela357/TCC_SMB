...
import 'novo_cartao_model.dart';
export 'novo_cartao_model.dart';

class NovoCartaoWidget extends StatefulWidget {
  const NovoCartaoWidget({super.key});

  @override
  State<NovoCartaoWidget> createState() => _NovoCartaoWidgetState();
}

class _NovoCartaoWidgetState extends State<NovoCartaoWidget> {
  late NovoCartaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NovoCartaoModel());
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: ToggleIcon(
                        onPressed: () async {
                          safeSetState(() =>
                              FFAppState().ncCredito = !FFAppState().ncCredito);
                        },
                        value: FFAppState().ncCredito,
                        onIcon: Icon(
                    ...
                    Align(
                      ...
                      child: ToggleIcon(
                        onPressed: () async {
                          safeSetState(() =>
                              FFAppState().ncSalvar = !FFAppState().ncSalvar);
                        },
                        value: FFAppState().ncSalvar,
                        onIcon: Icon(
                          Icons.check_box,
                          color: FlutterFlowTheme.of(context).primary,
                          size: 24.0,
                    ...
                    Align(
                      alignment: AlignmentDirectional(-0.41, 0.81),
                      child: Text(
                        'Salvar informações',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily:
                    ...
                    Align(
                      ...
                      child: ToggleIcon(
                        onPressed: () async {
                          safeSetState(() =>
                              FFAppState().ncDebito = !FFAppState().ncDebito);
                        },
                        value: FFAppState().ncDebito,
                        onIcon: Icon(
                          Icons.radio_button_checked,
                          color: FlutterFlowTheme.of(context).primary,
                          size: 24.0,
